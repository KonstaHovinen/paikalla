...
CREATE TYPE attendance_status AS ENUM ('PRESENT', 'ABSENT', 'LATE', 'UNKNOWN');
...
-- CUSTOM FIELDS DEFINITION (Future expansion)
CREATE TYPE custom_field_type AS ENUM ('text', 'number', 'select', 'boolean');
...
-- CUSTOM FIELD VALUES (Future expansion)
